...
from models import db_create_db, db_drop_db, add_seed_data
...
class CapstoneTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # producer token with perms to get:movies patch:movies
        ...
        # producer token with perms to get:movies post:movies
        # patch:movies delete:movies get:actors post:actors
    ...
    def test_post_movie(self):
        self.headers = {
            'Authorization': 'Bearer {}'.format(self.producer_token)}
        res = self.client().post("/movies", json=self.add_new_movie_data,
                                 headers=self.headers)  # test posting a movie
        self.assertEqual(res.status_code, 200)
        response = json.loads(res.data)
        self.assertTrue(response["success"])
        pass
    ...
    def test_patch_movie(self):
        self.headers = {
            'Authorization': 'Bearer {}'.format(self.producer_token)}
        res = self.client().patch("/movies/1", json=self.patch_movie_data,
                                  headers=self.headers)
        # test patching a movie
        self.assertEqual(res.status_code, 200)
        response = json.loads(res.data)
        pass
    ...
    def test_post_actor(self):
        self.headers = {
            'Authorization': 'Bearer {}'.format(self.producer_token)}
        res = self.client().post("/actors", json=self.add_new_actor_data,
                                 headers=self.headers)
        # test posting a actor
        self.assertEqual(res.status_code, 200)
        response = json.loads(res.data)
        self.assertTrue(response["success"])
        pass
    ...
    def test_patch_actor(self):
        self.headers = {
            'Authorization': 'Bearer {}'.format(self.producer_token)}
        res = self.client().patch("/actors/1", json=self.patch_actor_data,
                                  headers=self.headers)
        # test patching an actor
        self.assertEqual(res.status_code, 200)
        response = json.loads(res.data)
        pass
    ...
    def test_rbac_assistant_post_actor(self):
        ...
        res = self.client().post("/actors", json=self.add_new_actor_data,
                                 headers=self.headers)
        # test posting a actor as assistant
    ...
    def test_rbac_assistant_post_movie(self):
        ...
        res = self.client().post("/movies", json=self.add_new_movie_data,
                                 headers=self.headers)
        # test posting a movie as assistant
        self.assertEqual(res.status_code, 403)
        response = json.loads(res.data)
        self.assertEqual(response["success"], False)
        pass
    ...
    def test_rbac_director_post_movie(self):
        ...
        res = self.client().post("/movies", json=self.add_new_movie_data,
                                 headers=self.headers)
        # test posting a movie as director
        self.assertEqual(res.status_code, 403)
        response = json.loads(res.data)
        self.assertEqual(response["success"], False)
        pass
    ...
    def test_rbac_director_delete_movie(self):
        self.headers = {
            'Authorization': 'Bearer {}'.format(self.director_token)}
        # test deleting a movie as director
    ...
    def test_404(self):
        res = self.client().get("/moviesspelledwrong")
